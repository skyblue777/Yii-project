...
class UserBase extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'createdDate' => Language::t(Yii::app()->language,'Backend.User.Common','Created Date'),
			'last_login' => Language::t(Yii::app()->language,'Backend.User.Common','Last Login'),
			'validation_code' => Language::t(Yii::app()->language,'Backend.User.Common','Validation Code'),
			'validation_type' => Language::t(Yii::app()->language,'Backend.User.Common','Validation Type'),
			'validation_expired' => Language::t(Yii::app()->language,'Backend.User.Common','Validation Expired'),
			'status' =>Language::t(Yii::app()->language,'Backend.Common.Common','Status'),
			'first_name'=>Language::t(Yii::app()->language,'Backend.User.Common','First name'),
			'last_name'=>Language::t(Yii::app()->language,'Backend.User.Common','Last name'),
			'subject' => Language::t(Yii::app()->language,'Backend.User.Common','Subject'),
			'message' => Language::t(Yii::app()->language,'Backend.User.Common','Message'),
			'verifyCode' => Language::t(Yii::app()->language,'Backend.User.Common','Verify Code'),
			'confirmPassword' => Language::t(Yii::app()->language,'Backend.User.Common','Confirm Password'),
		);
	}
	/**
