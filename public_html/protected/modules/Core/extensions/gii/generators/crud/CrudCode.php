...
class CrudCode extends CCodeModel
{
	public $model;
	public $controller;
	public $baseControllerClass='BackOfficeController';
	...
	public function prepare()
	{
		...
		$this->files[]=new CCodeFile(
			$this->Module->BasePath.DIRECTORY_SEPARATOR.'services'.DIRECTORY_SEPARATOR.$this->getModelClass().'APIService.php',
			$this->render($serviceTemplateFile)
		);
