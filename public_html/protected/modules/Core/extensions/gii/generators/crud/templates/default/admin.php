...
<?php echo "<?php"; ?> $grid = $this->widget('zii.widgets.grid.CGridView', array(
...
if ($grid->dataProvider->ItemCount) {
    $this->menu[] = array('label' => 'Delete selected items', 'url'=>$this->createUrl('delete'), 'linkOptions' => array('onclick'=>'return multipleDelete("<?php echo $this->class2id($this->modelClass); ?>-grid",this.href)'));
}
