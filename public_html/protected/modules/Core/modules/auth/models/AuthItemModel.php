...
class AuthItemModel extends CModel
{
	...
	*/
	public function attributeLabels()
	{
		return array(
			...
			'type'			=> Language::t(Yii::app()->language,'Backend.System.AuthItem','Type'),
		);
	}
	...
	*/
	...
	{
		return '<span class="superuser">(<span class="superuserText">'.Yii::t('AuthModule.core', 'superuser').'</span>)</span>';
	}
	...
	*/
	public function deleteOperationColumn()
	{
		return CHtml::linkButton(Yii::t('AuthModule.core', 'Delete'), array(
			...
			'confirm'=>Yii::t('AuthModule.core', 'Are you sure you want to delete this operation?'),
			'class'=>'deleteLink',
		));
	}
	...
	*/
	...
	{
		return CHtml::linkButton(Yii::t('AuthModule.core', 'Remove'), array(
	...
	*/
	...
	{
		return CHtml::linkButton(Yii::t('AuthModule.core', 'Revoke'), array(
