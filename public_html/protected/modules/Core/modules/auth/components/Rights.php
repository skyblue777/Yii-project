...
class Rights
{
	...
	*/
	...
	{
	 	return array(
	 		CAuthItem::TYPE_OPERATION=>Yii::t('AuthModule.core', 'Operation'),
	 		CAuthItem::TYPE_TASK=>Yii::t('AuthModule.core', 'Task'),
	 		CAuthItem::TYPE_ROLE=>Yii::t('AuthModule.core', 'Role'),
		);
	}
	...
	*/
	public static function getAuthItemTypeName($type, $plural=false)
	{
		switch( (int)$type )
		{
			case CAuthItem::TYPE_OPERATION: return Yii::t('AuthModule.core', 'Operation');
			case CAuthItem::TYPE_TASK: return Yii::t('AuthModule.core', 'Task');
			case CAuthItem::TYPE_ROLE: return Yii::t('AuthModule.core', 'Role');
			// Invalid type
			default: throw new CException(Yii::t('AuthModule.core', 'Invalid authorization item type.'));
		}
	}
	...
	*/
	public static function getAuthItemTypeNamePlural($type)
	{
		switch( (int)$type )
		{
			case CAuthItem::TYPE_OPERATION: return Yii::t('AuthModule.core', 'Operations');
			case CAuthItem::TYPE_TASK: return Yii::t('AuthModule.core', 'Tasks');
			case CAuthItem::TYPE_ROLE: return Yii::t('AuthModule.core', 'Roles');
			// Invalid type
			default: throw new CException(Yii::t('AuthModule.core', 'Invalid authorization item type.'));
		}
	}
	...
	*/
	private static function findModule($module=null)
	{
		...
		if( ($m = $module->getModule('auth'))!==null )
			return $m;
