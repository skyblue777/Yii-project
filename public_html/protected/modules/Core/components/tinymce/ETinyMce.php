...
//      $this->setLanguage(Yii::app()->language);
   ...
   protected function makeCustomEditor($url='')
   {
      ...
      $this->plugins = array('safari','pagebreak','style','layer','table','save','advimage','advlink','emotions','spellchecker','inlinepopups','insertdatetime','preview','media','searchreplace','print','contextmenu','paste','directionality','fullscreen','noneditable','visualchars','nonbreaking','xhtmlxtras','template');
      ...
      $options['theme_advanced_toolbar_align'] = 'left';
      $options['theme_advanced_path_location'] = 'bottom';
		$options['theme_advanced_buttons1'] = "cut,copy,paste,pastetext,pasteword,justifyleft,justifycenter,justifyright,justifyfull,bullist,numlist,outdent,indent,help";
		//$options['theme_advanced_buttons2'] = "{$sc}formatselect,fontselect,fontsizeselect,|,forecolor,backcolor,|,bold,italic,underline,strikethrough,|,sub,sup{$c1}";
		//$options['theme_advanced_buttons3'] = "justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,|,charmap,emotions,media,image,|,link,unlink,anchor,|,insertdate,inserttime";
		//$options['theme_advanced_buttons4'] = "{$c2}tablecontrols,|,insertlayer,moveforward,movebackward,absolute,|,styleprops,del,ins,attribs,|,template";
//		$options['theme_advanced_toolbar_location'] = "'top'";
//		$options['theme_advanced_toolbar_align'] = "'left'";
//		$options['theme_advanced_statusbar_location'] = "bottom";
...
EOP;
      ...
      if ($this->useSwitch && !$this->readOnly) {
         ...
         $switch = CHtml::tag('div', array('style'=>'float:left'), CHtml::tag('span', array(), $link));
         $html = CHtml::tag('div', array('style'=>'float:left'), $textarea.$switch);
      }
      else {
         $html = $textarea;
      }
