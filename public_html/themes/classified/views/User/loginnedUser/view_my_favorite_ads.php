...
$this->breadcrumbs=array(
    Language::t(Yii::app()->language,'Frontend.User.Login','My Favorites')
);
$this->pageTitle = Settings::SITE_NAME.' - '.Language::t(Yii::app()->language,'Frontend.User.Login','My Favorites');
?>
...
<h1 class="title-3"><?php echo Language::t(Yii::app()->language,'Frontend.User.Login','My Favorites')?></h1>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            ...
            'template'=>'{delete-ad-from-favorite}',
            'buttons'=>array(
                'delete-ad-from-favorite'=>array(
                     'label'=>Language::t(Yii::app()->language,'Backend.Common.Common','Delete'),
                    'url'=>'$data->id',
                    'imageUrl'=>baseUrl().'/images/button-del-bg.gif',
                    'options'=>array('class'=>'delete-ad-from-favorite')
                ),
            )
        ),
    ),
...
$('table.items tr td a.delete-ad-from-favorite').live('click',function(){
...
$('table.items tbody tr.row-ask-delete-ad td a.agree-delete').live('click',function(){
    ...
    $.post(
        ...
        {
            SID : 'Ads.Ads.deleteFromFavorite',
            'ad_id': ad_id                        
        },
        function(json)
        {
