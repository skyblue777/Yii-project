...
$requirements=array(
	...
	array(
		...
		'<a href="#/doc/api/CHtmlPurifier">CHtmlPurifier</a>, <a href="#/doc/api/CWsdlGenerator">CWsdlGenerator</a>',
		''),
	array(
		t('yii','PDO extension'),
		false,
		extension_loaded('pdo'),
		t('yii','All <a href="#/doc/api/#system.db">DB-related classes</a>'),
		''),
	array(
	...
	array(
		...
		'<a href="#/doc/api/CMemCache">CMemCache</a>',
		extension_loaded("memcached") ? t('yii', 'To use memcached set <a href="#/doc/api/CMemCache#useMemcached-detail">CMemCache::useMemcached</a> to <code>true</code>.') : ''),
	array(
		t('yii','APC extension'),
		false,
		extension_loaded("apc"),
		'<a href="#/doc/api/CApcCache">CApcCache</a>',
		''),
	array(
		t('yii','Mcrypt extension'),
		false,
		extension_loaded("mcrypt"),
		'<a href="#/doc/api/CSecurityManager">CSecurityManager</a>',
		t('yii','This is required by encrypt and decrypt methods.')),
	array(
		t('yii','SOAP extension'),
		false,
		extension_loaded("soap"),
		'<a href="#/doc/api/CWebService">CWebService</a>, <a href="#/doc/api/CWebServiceAction">CWebServiceAction</a>',
		''),
	array(
		...
		($message=checkGD()) === '',
		//extension_loaded('gd'),
		'<a href="#/doc/api/CCaptchaAction">CCaptchaAction</a>',
		$message),
);
...
function getServerInfo()
{
	...
	$info[]='<a href="#/">Application Framework</a>/'.getYiiVersion();
